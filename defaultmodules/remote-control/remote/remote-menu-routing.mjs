...
export const MENU_NAMES = new Set([
  "main-menu",
  "power-menu",
  "edit-menu",
  "settings-menu",
...
export const STATIC_MENU_NAMES = MENU_NAMES;
  ...
  Object.assign(remote, {
    ...
    resolveRoute (menuName = "main-menu") {
      ...
      const targetMenu = menuName,
        isKnownMenu = MENU_NAMES.has(targetMenu) || Boolean(this.findDynamicMenuData(targetMenu));
      if (isKnownMenu) {
