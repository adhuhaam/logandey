  ...
  Object.assign(remote, {
    ...
    async applyMainMenuVisibilityRules () {
      ...
      try {
        ...
        const moduleConfig = configData.modules.find((m) => m.module === "remote-control").config,
  ...
  Object.assign(remote, {
    ...
    updateHeaderTitle (menuName) {
      ...
      try {
        ...
        if (taglineElement) {
          const isMainMenu = (menuName || this.currentMenu || "main-menu") === "main-menu";
          taglineElement.classList.toggle("hidden", !isMainMenu);
          if (isMainMenu) {
            taglineElement.textContent = this.translate("TAGLINE");
          }
        }
