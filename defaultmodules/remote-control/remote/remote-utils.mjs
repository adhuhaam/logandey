...
Object.assign(
  Remote,
  {
    ...
    loadLinks () {
      ...
      const items = [
        {"icon": "fa-television", "text": this.translate("VIEW_MIRROR"), "url": "/"},
        {"icon": "fa-github", "text": this.translate("REPOSITORY"), "url": "https://github.com/adhuhaam/logandey"},
        {"icon": "fa-envelope", "text": this.translate("CONTACT_EMAIL"), "url": "mailto:adhuhamlayaal55@gmail.com"},
